  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 py-4 text-sm">
      <section>
        ...
        <div className="md-prose rounded-md border border-slate-800 bg-slate-900/50 p-3 text-slate-200">
      ...
      {pending && (
        <section className="mt-5 space-y-3">
          ...
          {lastError && (
            <div className="rounded-md border border-rose-950 bg-rose-950/30 p-2 text-xs text-rose-200">
            ...
            <>
              <label className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="rounded-md border border-slate-800 bg-slate-950 px-2 py-1 text-xs focus:border-slate-600 focus:outline-none"
                />
              </label>
              <label className="flex flex-col gap-1">
                <span className="text-[11px] uppercase tracking-wider text-slate-500">
                ...
                <textarea
                  ...
                  rows={8}
                  className="resize-none rounded-md border border-slate-800 bg-slate-950 px-2 py-2 font-mono text-xs leading-relaxed focus:border-slate-600 focus:outline-none"
                />
              </label>
              {parseError && (
                <div className="rounded-md border border-rose-950 bg-rose-950/30 p-2 text-xs text-rose-200">
          ...
          <label className="flex flex-col gap-1">
            ...
            <textarea
              ...
              rows={2}
              className="resize-none rounded-md border border-slate-800 bg-slate-950 px-2 py-1 text-xs focus:border-slate-600 focus:outline-none"
            />
          </label>
