...
class Node(BaseModel):
    ...
    # Exact per-node instructions prepared for the provider system prompt.
    # This is kept separate from ContextSpace's system text for auditing;
    # providers place it before that context when composing the prompt.
